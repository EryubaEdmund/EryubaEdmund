...
| **Foundational Concepts** | Cloud computing, relational & non-relational data models, ETL architecture |
...
In line with my trajectory from analytics to engineering to intelligent systems:

- **Machine Learning Engineering** — Scikit-learn, model training, feature pipelines, and evaluation frameworks
- **Deep Learning** — TensorFlow and PyTorch for applied neural network development
- **MLOps & Model Deployment** — bridging the gap between trained models and production environments; CI/CD for ML
- **Full-stack data applications** — combining backend pipelines with interactive frontends to deliver end-to-end data products
